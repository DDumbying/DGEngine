...
int main(void) {
    ...
    entity_add_renderable(&reg, e1, (RenderableComponent){0.1f, 0.2f, 0.3f, 1.0f, 10.0f, 20.0f});
    ...
    entity_add_renderable(&reg, e3, (RenderableComponent){0.55f, 0.55f, 0.58f, 1.0f, 18.0f, 14.0f});
